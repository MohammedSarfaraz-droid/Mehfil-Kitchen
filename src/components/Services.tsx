                ...
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {services.map((service, idx) => (
                            <div
                                key={idx}
                                className="bg-[#e6d38d] text-black border-2 border-[#eee] px-[42px] py-[30px] rounded-[10px] text-center transition-all duration-300 hover:bg-[#1a3c34] hover:text-white"
                            >

  ...
  return (
    ...
    >
      <div className="relative max-w-7xl mx-auto flex items-center justify-between px-5 py-3 min-h-[120px] ">
        ...
        {/* Left Links */}
        <div className="hidden lg:flex items-center gap-20 text-white flex-1 justify-start">
          {['Home', 'About', 'Gallery'].map((text) => (
            <Link
              key={text}
        ...
        <div className="hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-auto">
          <Link href="/">
        ...
        {/* Right Links */}
        <div className="hidden lg:flex items-center gap-10 text-white flex-1 justify-end">
          {['Menu', 'Catering', 'Contact'].map((text) => (
      ...
      >
        <div className="px-6 py-4 text-black space-y-2">
          ...
          <div className='flex flex-row gap-4 pt-3 justify-center'>
            ...
            <div className='flex items-center justify-center w-10 h-10 rounded-full bg-black  hover:bg-[#1a3c34] transition-all duration-300'>
              {/* Cart Icon */}
              <CartIcon />
            </div>
            {/* Twitter/X */}
